...
import 'chicken_burger_top_section.dart';

class ChickenBurgerDetail extends StatelessWidget {
  const ChickenBurgerDetail({super.key});
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Pepper Chicken Burger Only 39 baht (Limited purchase per transaction per day per ID, Repeating offer after midnight)',
                  style: TextStyle(
                    fontSize: 16,
                    color: Colors.black,
                  ),
