...
import 'cheese_burger_top_section.dart';
import 'redeem_popup.dart'; // Import the new redeem popup file // Import the Terms & Conditions page

class CheeseBurgerDetail extends StatelessWidget {
  const CheeseBurgerDetail({super.key});
    ...
    return Scaffold(
        ...
        children: [
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  '(Limited purchase per transaction, Repeating offer after midnight)',
                  style: TextStyle(
                    fontSize: 16,
                    color: Colors.black,
                  ),
                ...
                const ListTile(
                  leading: Icon(Icons.loop, color: Colors.black),
                  title: Text('Repeating offer'),
                ),
                const Divider(height: 2),
                const ListTile(
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: IconButton(
                padding: const EdgeInsets.only(left: 9), // Adjust padding to move arrow right
      ...
      bottomNavigationBar: Container(
        ...
        child: ElevatedButton(
          onPressed: () => RedeemPopup.show(context), // Call the show method from RedeemPopup
