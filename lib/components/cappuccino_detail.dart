...
import 'cappuccino_top_section.dart';

class CappuccinoDetail extends StatelessWidget {
  const CappuccinoDetail({super.key});
        ...
        children: [
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                // Top section with the image and price details
                const CappuccinoTopSection(),
                ...
                const Text(
                  '(Limited purchase per transaction per day per ID, Repeating offer after midnight)',
                  style: TextStyle(
                    fontSize: 16,
                    color: Colors.black,
                  ),
