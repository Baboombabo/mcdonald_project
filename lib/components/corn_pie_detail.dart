...
import 'corn_pie_top_section.dart';

class CornPieDetail extends StatelessWidget {
  const CornPieDetail({super.key});
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Corn Pie. Only 19 baht. (Offer is limited to one redemption throughout the campaign period)',
                  style: TextStyle(
                    fontSize: 16,
                    color: Colors.black,
                  ),
