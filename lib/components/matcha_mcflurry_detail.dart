...
import 'package:mcdonald_project/components/matcha_top_section.dart';
...
class MatchaMcflurryDetail extends StatelessWidget {
  const MatchaMcflurryDetail({super.key});
        ...
        children: [
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const MatchaMcflurryTopSection(),
                const SizedBox(height: 15),

                // Description Section
                const Text(
                  '(11 AM - 5 AM) Matcha McFlurry',
                  style: TextStyle(
                    fontSize: 24,
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: IconButton(
                padding: const EdgeInsets.only(left: 8), // Adjust padding to move arrow right
