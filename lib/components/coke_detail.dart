...
import 'coke_top_section.dart';

class CokeDetail extends StatelessWidget {
  const CokeDetail({super.key});
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Coke 12 oz. Only 9 baht. (Offer is limited to one redemption throughout the campaign period)',
                  style: TextStyle(
                    fontSize: 16,
                    color: Colors.black,
                  ),
